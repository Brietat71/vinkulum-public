...
STYLES = {
    "reference_010": ("Vinkulum 0.10 · API + bornes", "#77858d", "s"),
    "api_011": ("Vinkulum 0.11 · unitaire + bornes", "#15636c", "^"),
    "lot_011": ("Vinkulum 0.11 · groupé + bornes", "#00a58a", "o"),
...
def tracer(bilan, destination):
    ...
    fig.suptitle("Réponses avec bornes : gain de la version 0.11.0", x=.065,
