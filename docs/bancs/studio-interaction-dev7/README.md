...
The candidates measured here predate the unified project browser and embedded
analysis views. No claim that these samples describe the final source hash is made.
...
Xvfb screen; viewport dimensions are recorded in each file. The screenshot is the actual earlier installed dev7
interaction candidate, before unified navigation. No first-frame deadline or Mac speedup follows from these samples.
